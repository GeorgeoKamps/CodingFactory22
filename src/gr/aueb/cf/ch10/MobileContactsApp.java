...
public class MobileContactsApp {
                ...
                try {
                    ...
                    switch (choice) {
                        case 1:
                            ...
                            System.out.println("Επιτυχης εισαγηγη");
                            break;
                        case 2:
                            phoneNumber = getPhoneNumber();
                            deleteController(phoneNumber);
                            System.out.println("Epityxis diagrafi");
                            break;
                        case 3:
                            phoneNumber = getPhoneNumber();
                            printContactMenu();
                            updateController(phoneNumber, getFirstName(), getLastName(), getPhoneNumber());
                            System.out.println("epitixis enimerisi");
                            break;
                        case 4:
                            phoneNumber = getPhoneNumber();
                            String[] contact = getOneContactService(phoneNumber);
    ...
    public static void printMenu() {
        ...
        System.out.println("5. Εκτυπωση επαφης");
        System.out.println("Q or q. Εξοδος");
    }
    ...
    public static void printContactMenu() {
        System.out.println("Εισαγετε Oνομα, Επωνυμο και τηλεφωνο");
    }
    ...
    public static void updateController(String oldPhoneNumber,String firstname,
        ...
        try {
            ...
            if (newPhoneNumber.length() < 2 || newPhoneNumber.length() > 12) {
                throw new IllegalArgumentException("new Phone number not valid");
            }
